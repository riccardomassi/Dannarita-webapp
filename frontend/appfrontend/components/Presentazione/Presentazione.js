...
const Presentazione = () => {
  return (
    <div className="relative h-screen w-full flex items-end justify-start text-2xl">
      ...
      <div className="relative z-10 bg-black bg-opacity-85 shadow-2xl py-6 px-10 ml-16 mb-32 rounded-br-2xl font-serif text-center text-white">
